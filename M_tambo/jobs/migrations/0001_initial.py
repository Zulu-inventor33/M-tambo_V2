...
<<<<<<< HEAD
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_logs', to='maintenance_companies.maintenancecompanyprofile')),
...
=======
                ('elevator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_logs', to='elevators.elevator')),
                ('maintenance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_logs', to='account.maintenance')),
                ('technician', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maintenance_logs', to='account.technician')),
>>>>>>> 599bc3919ee2d2b1d710c4b3cba10c43d769a0fb
            ],
        ),
        migrations.CreateModel(
...
<<<<<<< HEAD
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_schedules', to='maintenance_companies.maintenancecompanyprofile')),
